      ...
      >
        ...
        <el-row>
          ...
          <el-form-item
            ...
            ><el-select v-model="addForm.packaging" popper-class="z">
        ...
        <el-row>
          <el-form-item
            ...
            ><el-select v-model.number="addForm.format" popper-class="z">
        ...
        <el-form-item label="类型">
          <el-checkbox-group v-model="addForm.type" :max="3">
        ...
        <el-form-item>
          <el-button @click="add(froms)">确认</el-button>
  ...
  <el-table :data="filterTableData" style="width: 100%">
    ...
    <el-table-column align="right">
      ...
      <template #default="scope">
        ...
        <el-button size="small" @click="added(scope.row.id)">上架</el-button>
